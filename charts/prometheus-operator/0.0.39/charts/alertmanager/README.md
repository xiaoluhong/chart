...
--- | --- | ---
`enabled` | Alertmanager enable or not | `true`
`apiGroup` | The group name for Prometheus Operator CRD | `monitoring.coreos.com`
`enabledDefaultPrometheusRules` | Use default Prometheus Rules | `[templates/alertmanager.rules.yaml](templates/alertmanager.rules.yaml)`
